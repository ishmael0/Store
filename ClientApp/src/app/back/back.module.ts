  ...
  [
    ...
    new EntityConfiguration(ProductComponent, 'Product', "محصولات", {
      ...
      propertiesConfigurations: [
        ...
        new PropertyConfiguration('ProductLabels', 'لیبل ها  ', { Type: 'custom', value: [], Validators: [], InTable: false }),
        ...
        new PropertyConfiguration('ProductKeyWords', ' کلید واژه ها', { Type: 'custom', value: [], Validators: [], InTable: false }),
